-- Atualizar função para manter valores provisórios em vez de strings vazias
...
BEGIN
  ...
  -- Limpar user_id, e setar email e phone para valores provisórios, mantendo full_name, description e photo_url
