      ...
      <div className={styles.Auditory}>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.textContent}>
              O auditório do CPGG se localiza na sede do CPGG, Bloco E anexo ao Instituto de Geociências da UFBA. Conta com uma estrutura para 30 pessoas, quadro branco, datashow, caixa de som, iluminação diferenciada, ar-condicionados. É utilizado para seminários, defesas de tese, palestras e aulas. O uso prioritário é para atividades do CPGG, e para atender às necessidades de seus membros. Reservas podem ser feitas pelo link abaixo:
            </div>
