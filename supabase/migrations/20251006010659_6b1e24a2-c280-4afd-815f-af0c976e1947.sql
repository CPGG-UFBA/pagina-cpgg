...
-- Apenas insere se não existir perfil com o mesmo nome

-- Primeiro, adicionar constraint UNIQUE em full_name para evitar duplicatas
ALTER TABLE user_profiles ADD CONSTRAINT user_profiles_full_name_key UNIQUE (full_name);

-- Agora inserir os pesquisadores com ON CONFLICT DO NOTHING
