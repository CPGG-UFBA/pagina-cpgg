-- Atualizar função para limpar email e telefone também, mantendo apenas nome, descrição e foto
...
BEGIN
  ...
  -- Limpar user_id, email e phone do perfil, mantendo full_name, description e photo_url
